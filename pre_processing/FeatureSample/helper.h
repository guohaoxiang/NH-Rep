...
#include "Eigen/Dense"
void compute_shortest_dist_AABB(const Eigen::MatrixXd& input_pts, const Eigen::MatrixXi input_faces, const std::vector<TinyVector<double, 3>>& queries, std::vector<TinyVector<double, 3>>& res, std::vector<double>& dist, std::vector<size_t>& faceid);
